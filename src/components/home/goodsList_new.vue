	...
	<div class="goodsList_new">
		...
		<div class="goodsListContainer" :style="bgCss">
			<div class="new_theme">
				...
				<span class="s3" @click="goto('searchlist')" @click.self="gotoList">查看全部</span>
			</div>
			<ul class="new_box">
				<li class="newItem" v-for="item in goodsList_new" :key="item.goodsId" @click="goto(item.goodsId)">
					<img :src="item.image" />
